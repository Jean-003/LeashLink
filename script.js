...
// function fetchData() {
//   var queryURL = "https://www.eventbriteapi.com/v3/users/me/?token=5U4THKH6LP7JBXOQLYHH"
...
var url = 'https://auth.calendly.com/oauth/token';
var data = new URLSearchParams();
data.append('grant_type', 'authorization_code');
data.append('code', 'YOUR_AUTHORIZATION_CODE');
data.append('redirect_uri', 'YOUR_REDIRECT_URI');

var requestAuth = new XMLHttpRequest();
requestAuth.open('POST', url);
requestAuth.setRequestHeader('Accept', 'application/json');
requestAuth.setRequestHeader('Authorization', 'Basic 123');
...
function fetchData() {
      var queryURL = "https://auth.calendly.com/oauth/authorize"
